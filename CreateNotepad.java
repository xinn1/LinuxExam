...
public class CreateNotepad extends HttpServlet {
    ...
    final static String URL = "jdbc:mysql://124.70.131.236/linux_final";
    final static String USER = "root";
    final static String PASS = "Wx1234/@";
    final static String SQL_INSERT_NOTEPAD = "INSERT INTO t_Notepad(id,notepadContent,notepadTime) VALUES (?,?, ?)";
